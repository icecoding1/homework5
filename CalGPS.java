...
class CalGPS extends Frame implements ActionListener {
    String edu =  "1/2548";
    int Credits;
    double GPS;
    ...
    String subject[] = {"Modern Programming", "Computer Graphics", "Project II", "Subject", "Subject", "Subject", "Subject", "Subject", "Subject", "Subject"};
